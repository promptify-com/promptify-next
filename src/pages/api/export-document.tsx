...
const generatePDF = (data: any[], res: NextApiResponse) => {
...
const generateDOCX = async (data: any[], res: NextApiResponse) => {
  const sections = [];
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const { data, format }: { data: any; format: "pdf" | "docx" } = req.body;
