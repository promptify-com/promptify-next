  ...
  return (
    <Layout>
      ...
      >
        ...
        >
          <Box component={"p"}>
            Promptify LLC, along with its affiliates ("Promptify", "Promptify.com", "we", "us" or "our"), respects your
            privacy and is dedicated to safeguarding any information we gather from you or about you. This Privacy
            Policy outlines how we handle Personal Information that we accumulate when you use our website,
            applications, and services (collectively, "Services"). This policy does not apply to content that we process
            on behalf of our business customers, such as through our API. Such data usage is governed by the customer
            agreements for access and use of these offerings. To understand how we gather and utilize training
            information for the development of our language models that power ChatGPT and other Services, and to know
            your choices regarding that information, please refer to this help center article.
            <br />
            <br />
            To understand how we gather and utilize training information for the development of our language models that
            power ChatGPT and other Services, and to know your choices regarding that information, please refer to this
            help center article.
          </Box>
          ...
          <Box component={"p"}>
            ...
            Services ("Content").Communication Data: If you interact with us, we collect your name, contact details, and
            the content of any messages you send, referred to as "Communication Information."
          </Box>
          ...
          <Box component={"p"}>
            ...
            Personal Information that you choose to provide to us, such as your contact details ("Social Information").
            Additionally, the companies hosting our social media pages may provide us with aggregate information and
            analytics regarding our social media activity.Information We Receive Automatically: When you visit, use, or
            interact with our Services, we receive information about your visit, use, or interactions, known as
          ...
          <Box>
            We use cookies to operate and administer our Services, and to improve your user experience. A "cookie" is a
            piece of information sent to your browser by a website you visit. You can set your browser to accept all
            cookies, reject all cookies, or notify you whenever a cookie is offered so you can decide each time whether
            to accept it. However, refusing a cookie may, in some cases, prevent you from using or negatively affect the
            display or function of a website or certain areas or features of a website. For more information on cookies,
            please visit All About Cookies.Analytics: We may use a variety of online analytics products that use cookies
            to help us analyze how users use our Services and to enhance your experience when using the Services.
            <br />
            <br />
            <Box component={"ul"}>
          ...
          <Box>
            ...
            <Box component={"ol"}>
              ...
              <Box component={"li"}>
                Changes to Privacy PolicyWe may revise our Privacy Policy from time to time. The most current version of
                the Privacy Policy will govern our use of your Personal Information and will be located on our website.
              </Box>
              <Box component={"li"}>
                Contact InformationFor any questions, comments, or concerns about this Privacy Policy, please contact us
                at: <a href="mailto:privacy@promptify.com">privacy@promptify.com</a>
              </Box>
            </Box>
          </Box>
          <Box component={"h2"}>4. Your Rights</Box>
          <Box>
            Depending on your location, individuals in the EEA, the UK, and globally may have certain legal rights with
            regard to their Personal Information. These rights may include:
            <br />
            <br />
            <Box component={"ul"}>
              <Box component={"li"}>
              ...
              <Box component={"li"}>
                The right to withdraw your consent at any time, if we rely on consent as the legal basis for processing.
              </Box>
              ...
              <Box component={"li"}>
                Some of these rights can be exercised through your Promptify account. If you're unable to exercise your
                rights through your account, please direct your request to our designated email.
              </Box>
            </Box>
            <br />
            <b>A Note on Accuracy:</b> Services like ours generate responses by interpreting a user's request and
            predicting the words most likely to appear next. In certain cases, the words most likely to appear next may
            not be the most factually accurate. Therefore, you shouldn't rely on the factual accuracy of our model
            outputs. If you notice any factual inaccuracies about you in the model outputs and would like us to correct
            them, you may submit a correction request to our designated email. Due to the technical complexity of our
            models, we might not always be able to correct inaccuracies. In such cases, you may request that we remove
            your Personal Information from the model's output by completing a specific form.
            <br />
            <br />
            For information on exercising your rights in relation to data we've collected from the internet to train our
            models, please refer to this help center article.
          </Box>
          ...
          <Box>
            ...
            disclose that information. You can find further information about the Personal Information we collect in the
            section "Personal Information We Collect" above, our use of Personal Information in the "How We Use Personal
            Information" section above, and our retention of Personal Information in the "Security and Retention"
            section below.
            <br />
            <br />
            Category of Personal InformationDisclosure of Personal InformationIdentifiers, such as your name, contact
            details, IP address, and other device identifiersWe disclose this information to our affiliates, vendors and
            service providers, law enforcement, and parties involved in Transactions.Commercial Information, such as
            your transaction historyWe disclose this information to our affiliates, vendors and service providers, law
            enforcement, and parties involved in Transactions.Network Activity Information, such as Content and how you
            interact with our ServicesWe disclose this information to our affiliates, vendors and service providers, law
            enforcement, and parties involved in Transactions.Geolocation DataWe disclose this information to our
            affiliates, vendors and service providers, law enforcement, and parties involved in Transactions.Your
            account login credentials and payment card information (Sensitive Personal Information)We disclose this
            information to our affiliates, vendors and service providers, law enforcement, and parties involved in
            Transactions.
            <br />
            <br />
            As a response to local regulations and in accordance with relevant exceptions, individuals can exercise the
            following privacy rights in relation to their Personal Information when using Promptify.com:
            <br />
            <br />
            <Box component={"ul"}>
              <Box component={"li"}>
          ...
          <Box component={"p"}>
            ...
            media services (“Third Party Sites”). The information you share with these Third Party Sites is governed by
            their own privacy policies and terms of service, not by this Privacy Policy. We offer these links without
            implying endorsement or approval of these sites. Please contact these Third Party Sites directly for details
          ...
          <Box>
            By using our Service, you understand and accept that your Personal Information will be processed and stored
            in our facilities and servers in the United States and may be disclosed to our service providers and
            ...
            <br />
            EEA and UK Representative: We have appointed representatives in the EEA and UK for data protection matters.
            You can contact them at <a href="mailto:eu-privacy@promptify.com">eu-privacy@promptify.com</a>.
