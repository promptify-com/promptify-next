...
import { ExportPopupChat } from "./ExportPopup";
const AntThinkingComponent = lazy(() => import("@/components/Automation/ChatInterface/messages/AntThinking"));
const AntArtifactComponent = lazy(() => import("@/components/Automation/ChatInterface/messages/AntArtifact"));
...
export default function Message({
  ...
  const gptGenerationStatus = useAppSelector(state => state.chat?.gptGenerationStatus ?? null);
